...
/**
 * check_for_builtins - This fxn checks whether the cmd is a builtin
...
/**
 * new_exit - This handle exit when cmd is the str "exit"
...
/**
 * _env - A function to prints the current environment
...
/**
 * new_setenv - This creates anew environ var, or edits an existing var
...
/**
 * new_unsetenv - This remove an environment var
 * @vars: A pointer to a struct of var
 *
 * Return: void
 */
