#include "shell.h"
/**
 * path_execute - D path to executable
...
{
	pid_t child_pid; /* holds child ID */
...
/**
 * find_path - a function to find the PATH variable
...
/**
 * check_for_path - This checks if executable is in the PATH
 * @vars: variable pointer to path
 *
 * Return: Nothing
 */
...
/**
 * execute_cwd - fcn to exec cmd in the current working dir
 * @vars: pointer to a struct variable
 *
...
/**
 * check_for_dir - This checks if the command is a part of a path
 * @str: command
 *
