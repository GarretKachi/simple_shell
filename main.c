...
/**
 * sig_handler - A function to handle ^C interrupt signal
 * @uuv: Is required for signal function prototype but unused.
 *
...
/**
 * main - This is the entry function to the shell
