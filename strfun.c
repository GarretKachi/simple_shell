...
/**
 * _strdup - This makes a duplicate string
...
/**
 * _strcmpr - Custom string compares funtion for 2 strings
...
/**
 * _strcat - A function to concat two strings
...
/**
 * _strlen - This calaculates the length of a string
 * @str: this holds string passed
